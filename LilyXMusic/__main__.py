...
async def init():
    ...
    LOGGER("LilyXMusic.plugins").info("Successfully Imported Modules...")
    await userbot.start()
    await Lilyy.start()
    try:
        await Lilyy.stream_call("https://telegra.ph/file/4b622cc566a681694728f.mp4")
    ...
    await idle()
    await app.stop()
    LOGGER("LilyXMusic").info("Stopping LilyX Music Bot...")
